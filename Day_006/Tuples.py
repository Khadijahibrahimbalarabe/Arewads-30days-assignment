...
my_brothers = ('Hafiz','Hilal')
my_sisters = ('Humairah','Ummi','Hassanah', 'Hussainah')
...
a,b,c,d,e,f,*parents = family_members
print(parents) 


# Create fruits, vegetables and animal products tuples. 
# Join the three tuples and assign it to a variable called food_stuff_list.
...
'Grapes' in food_stuff_list #NameError:  food stuff tupple no longer exists
