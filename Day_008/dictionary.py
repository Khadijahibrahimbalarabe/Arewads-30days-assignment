...
student = dict()
student.update({'first_name': 'Khadijah', 'last_name': 'Ibrahim','gender': 'female','age': 33,'marital_status': 'Married','skills':['MySQL','PowerBI','Python'], 'country':'Nigeria','city': 'Kano','address': 'Rijiyar zaki'})
